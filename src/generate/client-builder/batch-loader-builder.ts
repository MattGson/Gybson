import { ColumnDefinition } from 'relational-schema';
...
export class BatchLoaderBuilder {
    ...
    public static getOneByColumnLoader(params: {
        ...
        const { methodParamType, loadFiltersSpread, uniqueLoadFilter, loaderName } =
            BatchLoaderBuilder.getLoadParams(params);
        return `
