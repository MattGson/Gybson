...
class SQLQueryBuilder {
    ...
    manyByCompoundColumnLoader(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            logging_1.logger().debug('SQL executing loading: %s with keys %j', query.toSQL().sql, loadValues);
    ...
    byCompoundColumnLoader(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return sortKeys.map((k) => {
                if (keyed[k])
                    return keyed[k];
                logging_1.logger().debug(`Missing row for ${this.tableName}, columns: ${columns.join(':')}, key: ${k}`);
                return null;
            });
        });
    }
    ...
    findMany(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!includeDeleted && this.hasSoftDelete())
                query.where({ [this.softDeleteColumnString]: false });
            logging_1.logger().debug('Executing SQL: %j', query.toSQL().sql);
            return query;
        });
    }
    /**
    ...
    upsert(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (insertRows.length < 1) {
                logging_1.logger().warn('Persistors.upsert: No values passed.');
                return null;
            }
            if (columnsToUpdate.length < 1 && !reinstateSoftDeletedRows) {
                logging_1.logger().warn('Persistor.upsert: No reinstateSoftDelete nor updateColumns. Use insert.');
                return null;
            }
