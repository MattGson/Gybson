export declare type plan_user_roles_role = 'OWNER' | 'COLLABORATOR' | 'VIEWER';
export declare type posts_type = 'FEEDBACK' | 'WELLNESS_COMMENT' | 'INJURY';
...
export declare namespace exercisesFields {
    type exercise_id = number;
    type unit_id = number;
    type max_score_best = boolean | null;
...
export declare namespace plan_user_rolesFields {
    type plan_id = number;
    type user_id = number;
    type role = plan_user_roles_role | null;
}
...
export interface DBTables {
    ...
    athlete_testing_benchmarks: athlete_testing_benchmarks;
    block_week_workouts: block_week_workouts;
    common_statistics: common_statistics;
    computed_wellness: computed_wellness;
    compute_control: compute_control;
    data_points: data_points;
    default_metric_ac_ratios: default_metric_ac_ratios;
    default_workload_metrics: default_workload_metrics;
    exercises: exercises;
    exercise_categories: exercise_categories;
    exercise_category_members: exercise_category_members;
    exercise_category_translations: exercise_category_translations;
    exercise_data_points: exercise_data_points;
    exercise_preferred_units: exercise_preferred_units;
    exercise_translations: exercise_translations;
    features: features;
    feature_sets: feature_sets;
    feedback: feedback;
    fitness_components: fitness_components;
    fitness_component_translations: fitness_component_translations;
    injuries: injuries;
    insights: insights;
    invites: invites;
    invite_team_members: invite_team_members;
    knex_data_migrations: knex_data_migrations;
    knex_data_migrations_lock: knex_data_migrations_lock;
    ...
    plans: plans;
    plan_block_weeks: plan_block_weeks;
    plan_block_week_fitness_components: plan_block_week_fitness_components;
    plan_progresses: plan_progresses;
    plan_sports: plan_sports;
    plan_user_roles: plan_user_roles;
    platforms: platforms;
    ...
    post_reply_messages: post_reply_messages;
    proficiencies: proficiencies;
    proficiency_translations: proficiency_translations;
    recommendations: recommendations;
    recommendations_assigned: recommendations_assigned;
    recommendation_translations: recommendation_translations;
    recommendation_wellness_metrics: recommendation_wellness_metrics;
    roles: roles;
    rpe_responses: rpe_responses;
    sessions: sessions;
    sessions_links: sessions_links;
    session_attachments: session_attachments;
    session_members: session_members;
    session_notes: session_notes;
    sets_reps: sets_reps;
    sets_reps_schemes: sets_reps_schemes;
    sports: sports;
    sport_translations: sport_translations;
    teams: teams;
    team_members: team_members;
    team_member_profiles: team_member_profiles;
    test_groups: test_groups;
    test_group_exercises: test_group_exercises;
    test_group_sessions: test_group_sessions;
    token: token;
    units: units;
    unit_types: unit_types;
    users: users;
    wellness_check_ins: wellness_check_ins;
    wellness_comments: wellness_comments;
    wellness_metrics: wellness_metrics;
    wellness_metric_statistics: wellness_metric_statistics;
    wellness_metric_translations: wellness_metric_translations;
    wellness_responses: wellness_responses;
    wellness_schedules: wellness_schedules;
